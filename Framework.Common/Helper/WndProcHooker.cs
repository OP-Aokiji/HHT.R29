...
namespace Framework.Common.Helper
{
    public class WndProcHooker
    {
        ...
        public static void MakeButtonMultiline(Button button)
        {
            IntPtr hwnd = button.Handle;
            int currentStyle = WinCE.GetWindowLong(hwnd, WinCE.GWL_STYLE);
            int newStyle = WinCE.SetWindowLong(hwnd, WinCE.GWL_STYLE, currentStyle | WinCE.BS_MULTILINE);
        }
        public static void MakeCheckboxMultiline(CheckBox checkbox)
        {
            IntPtr hwnd = checkbox.Handle;
            int currentStyle = WinCE.GetWindowLong(hwnd, WinCE.GWL_STYLE);
            int newStyle = WinCE.SetWindowLong(hwnd, WinCE.GWL_STYLE, currentStyle | WinCE.BS_MULTILINE);
        }
        ///////////////////////////////////// Make button text multiline ///////////////////////////////////
            ...
            Control ctl, WndProcCallback callback, uint msg)
        {
            ...
            if (hpi == null)
            {
                ...
                hpi = new HookedProcInformation(ctl,
                    new WinCE.WndProc(WndProcHooker.WindowProc));
            ...
            IntPtr hwnd, uint msg, uint wParam, int lParam)
        {
            ...
            return WinCE.DefWindowProc(hwnd, msg, wParam, lParam);
        }
        ...
        class HookedProcInformation
        {
            ...
            /// wndproc.
            /// </summary>
            private WinCE.WndProc newWndProc;
            ...
            public HookedProcInformation(Control ctl, WinCE.WndProc wndproc)
            {
                control = ctl;
                newWndProc = wndproc;
            ...
            public void SetHook()
            {
                ...
                oldWndProc = WinCE.SetWindowLong(hwnd, WinCE.GWL_WNDPROC,
            ...
            public void Unhook()
            {
                ...
                WinCE.SetWindowLong(hwnd, WinCE.GWL_WNDPROC, oldWndProc);
            }
